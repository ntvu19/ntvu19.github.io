    ...
    <div class="home-welcome">
        ...
        <div class="content">
            <div class="summany">
                ...
                <p>My primary areas of interest include building highly practical software, honing problem solving skills, writing maintainable and scalable code, optimizing systems through source code and databases, ensuring user data security, and more.</p>
                <p>During my free time, I like brainstorming ideas for software applications that cater to essential user needs and continually expanding my knowledge in these areas.</p>
            </div>
